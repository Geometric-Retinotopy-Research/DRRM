%% 
% Description  --  function write_mfile(filename,varargin)
%	  write .mat file in disk
% 
% Parameter(s): 
%     filename[string]     -- file name.
% 
%% 
%  write_mfile('out.m','Face',F,
%   'Vertex %d %f %f %f {uv=(%f %f %f) rgb={%f %f %f} thickness={%f}}\n',[vertex,uv_new,color,thickness]);
%%
...
edge = [];
for i = 1:length(varargin)
    if isa(varargin{i},'double') ||isa(varargin{i},'int32') 
        continue;
    end
