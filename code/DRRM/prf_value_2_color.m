%% 
%  Description  -- function color = prf_value_2_color(vartype, value, maxvalue)
%		make a prf render color from type and value array
%
%  Parameter(s): 
%       vartype[double array]    --  color type
%       value[double array]		 --  color value
%  Renturn:
%       color[double array]      --  a prf color value
%%
