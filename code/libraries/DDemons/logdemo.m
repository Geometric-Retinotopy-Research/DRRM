function res =logdemo(M,F, vx, vy)
% Demons Registration
%
...
% modified by yanshuai to pass initial px, py 
...
%     disp(['Register...']);
    ...
    opt = struct('niter',niter, 'sigma_fluid',sigma_fluid, 'sigma_diffusion',sigma_diffusion, 'sigma_i',sigma_i, 'sigma_x',sigma_x, 'do_display',do_display, 'do_plotenergy',0, 'vx', vx, 'vy', vy);
    end
